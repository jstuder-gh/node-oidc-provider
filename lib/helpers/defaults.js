...
function getDefaults() {
  const defaults = {
     ...
     *
     * description: Use the issuer URL to generate the OIDC endpoints. Useful in cases when server
     *   is behind proxy and use of x-forwarded-* headers are restricted.
     *
     */
